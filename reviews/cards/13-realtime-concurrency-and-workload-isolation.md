...
- `Requirement`: o que precisa ser realtime de verdade nesse produto?
- `Delete`: qual evento ou sala voce removeria antes de trocar runtime?
- `Forma mais simples`: isolar o workload quente sem reescrever o core inteiro.
