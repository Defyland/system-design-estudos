...
1. releia rapidamente os cards em pares:
   - [Card 02](./cards/02-pod-isolation-and-tenant-routing.md) + [Card 01](./cards/01-relational-scaling-and-operational-discipline.md)
   - [Card 03](./cards/03-idempotent-writes-under-ambiguous-failure.md) + [Card 05](./cards/05-durable-workflows-retries-and-compensation.md)
   - [Card 06](./cards/06-edge-rate-limiting-waf-and-gateway-boundaries.md) + [Card 07](./cards/07-critical-checkout-flows-and-auth-boundaries.md)
   - [Card 10](./cards/10-cdn-placement-dns-and-cache-invalidation.md) + [Card 08](./cards/08-blob-durability-and-storage-tiers.md)
