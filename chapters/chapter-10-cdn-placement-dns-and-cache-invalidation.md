# Chapter 10 - CDN Placement, DNS and Cache Invalidation
...
- `Study Order`: `10/14` - `Fase 2 - Caminhos criticos e dados especializados`
- `Caso real principal`: [Netflix - Open Connect CDN](../real-world-cases/04-edge-and-delivery/netflix-open-connect-cdn/README.md)
- `Caso real complementar`: [Cloudflare - Edge Platform](../real-world-cases/04-edge-and-delivery/cloudflare-edge-platform/README.md), [Meta - Video Delivery](../real-world-cases/04-edge-and-delivery/meta-video-delivery/README.md)
- `Area principal`: [04 - Edge, Rede e Acesso](../areas/04-edge-rede-e-acesso/README.md)
- `Notes principais`: [Edge, Rede e Acesso](../areas/04-edge-rede-e-acesso/notes.md)
...
- `Requirement Less Dumb`: a dor real e latencia global e protecao de origem, ou so um cache application-side mal aproveitado?
- `Delete`: remova camada duplicada de cache, purge exagerado e roteamento esperto sem caso de uso claro.
- `Simplify`: comece com cache de conteudo estavel e invalidacao previsivel antes de brincar de multi-CDN ou DNS sofisticado.
- `Accelerate`: teste TTL, hit ratio e rollback de regra de cache em poucas rotas antes de espalhar pela plataforma.
- `Automate Last`: traffic steering dinamico e politicas automaticas de invalidacao entram depois que o comportamento basico ficou entendido.

### Fixacao Relampago: Design Pass

- `Pergunta`: qual pergunta abre um tema de CDN de forma adulta?
- `Resposta com as suas palavras`: eu preciso saber que conteudo realmente se beneficia de edge e quanta staleness o produto tolera.
- `Resposta ruim que parece boa`: "joga tudo no CDN que fica rapido".
- `Troque por isto`: primeiro eu classifico o conteudo e o contrato de invalidez; so depois amplio a borda.
...
- [Prev](./chapter-09-search-indexing-and-permission-aware-retrieval.md)
- [Index](./README.md)
- [Next](./chapter-11-geospatial-indexing-for-marketplace-search.md)
