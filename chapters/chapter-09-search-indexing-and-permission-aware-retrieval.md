# Chapter 09 - Search Indexing and Permission-Aware Retrieval
...
- `Study Order`: `09/14` - `Fase 2 - Caminhos criticos e dados especializados`
- `Caso real principal`: [Dropbox - Nautilus Search](../real-world-cases/02-data-storage-and-search/dropbox-nautilus-search/README.md)
...
- `Requirement Less Dumb`: o usuario precisa de busca real com ACL, ranking e tolerancia a typo, ou so filtro e ordenacao mais honestos no banco?
- `Delete`: elimine campos, boosts e recursos de busca que ninguem usa antes de inflar o indice.
- `Simplify`: banco e source of truth; indice e materializacao derivada para leitura, nao dono do dado.
- `Accelerate`: monte reindex pequeno, dashboard de lag e comparacao entre resultado esperado e resultado entregue cedo.
- `Automate Last`: relevancia adaptativa, tuning automatico e pipelines sofisticados entram depois que frescor e permissao ja estao confiaveis.

### Fixacao Relampago: Design Pass

- `Pergunta`: o que voce prova antes de aceitar um search engine no desenho?
- `Resposta com as suas palavras`: eu provo que o banco nao entrega mais a experiencia de busca que o produto pede, especialmente com ACL e texto livre.
- `Resposta ruim que parece boa`: "tem texto pesquisavel, entao precisa de Elasticsearch".
- `Troque por isto`: primeiro eu valido a necessidade de semantica de busca; depois escolho o motor.
...
- [Prev](./chapter-08-blob-durability-and-storage-tiers.md)
- [Index](./README.md)
- [Next](./chapter-10-cdn-placement-dns-and-cache-invalidation.md)
