# Chapter 13 - Critical Checkout Flows and Auth Boundaries
...
- [Example - Smaller Marketplace Checkout Boundary](../areas/04-edge-rede-e-acesso/examples/smaller-marketplace-checkout-boundary.md)
- [Snippet - Rails Checkout Boundary and Auth Guard](../areas/04-edge-rede-e-acesso/snippets/rails-checkout-boundary-and-auth-guard.md)
...
- [Lab](../labs/chapters/chapter-13-critical-checkout-flows-and-auth-boundaries.md)
...
- [Prev](./chapter-12-geospatial-indexing-for-marketplace-search.md)
- [Index](./README.md)
