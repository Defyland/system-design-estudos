# Chapter 02 - Relational Scaling and Operational Discipline
...
- [Example - Smaller SaaS Read/Write and Cache](../areas/02-dados-e-armazenamento/examples/smaller-saas-read-write-and-cache.md)
- [Snippet - Rails Read/Write Split and Cache Aside](../areas/02-dados-e-armazenamento/snippets/rails-read-write-split-and-cache-aside.md)
...
- [Lab](../labs/chapters/chapter-02-relational-scaling-and-operational-discipline.md)
...
- [Prev](./chapter-01-pod-isolation-and-tenant-routing.md)
- [Index](./README.md)
- [Next](./chapter-03-blob-durability-and-storage-tiers.md)
